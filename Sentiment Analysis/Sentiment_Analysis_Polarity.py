...
# Remove 0 values
df['Polarity'] = df['Polarity'].replace(0, None)

# Plot
fig, ax = plt.subplots(figsize=(12.8, 7.2), dpi=100)
ax.plot(df['Date'], df['Polarity'], label='Polarity', color='blue')

# Title + label
plt.title("Polarity Over Time (1831–1836)")
